    ...
    public partial class InitialDBSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonWord", x => new { x.LessonsId, x.WordsId });
                    table.ForeignKey(
                        name: "FK_LessonWord_Lessons_LessonsId",
                        column: x => x.LessonsId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonWord_Words_WordsId",
                        column: x => x.WordsId,
